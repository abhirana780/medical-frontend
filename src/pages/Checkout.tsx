        ...
        <div className="checkout-page section">
            <div className="container">
                ...
                <div className="checkout-grid">
                    {/* Left Column: Forms */}
                    <form className="checkout-forms" onSubmit={handlePlaceOrder}>
                        ...
                        <div className="checkout-section">
                            ...
                            <div className="section-body">
                                ...
                                <button type="submit" disabled={isProcessing} className="btn btn-primary" style={{ marginTop: '2rem', width: '100%', padding: '1rem' }}>
